<template>
    <div class="w-5/6 h-screen mx-auto pt-12">
        <div class= "text-font flex justify-between">
            <div class="text-4xl text-main align-bottom mr-2">Search from Content</div>
        ...
        <div class="flex justify-center">
            <input type="text" class="rounded w-4/5 h-10 border-2 mt-3" placeholder="content word" v-model="state.word">
            <svg fill="#000000" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" width="50px" height="50px"
            class="fill-current" @click.stop="search">
        ...
        <div class="no-scrollbar mx-auto p-4">
            <div v-for="notice in state.notices" :key="notice.id" @click.stop="searchOne(notice.id)" class="flex justify-between text-font bg-panel w-full rounded-xl shadow-2xl p-4 m-2">
